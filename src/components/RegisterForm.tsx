...
const RegisterForm = (data: Props) => {
	...
	return (
		<>
			<h1 className="ml-6 font-bold text-2xl">Formulário de inscrição</h1>
			<div
				id="register-form"
				className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md border border-gray-300 mt-12 mb-32"
			>
				<h1 className="text-xl font-bold text-center flex items-center gap-2 justify-center ">
				...
				<form
					...
					className="space-y-6 flex flex-col gap-3 mt-12"
				>
					<div>
